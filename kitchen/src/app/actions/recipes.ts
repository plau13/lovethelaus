...
export async function saveNewRecipe(formData: FormData) {
  ...
  try {
    ...
    redirectActionError("/recipes/new", error, "recipes.create_failed", userId);
  }
}
...
export async function saveRecipeEdits(formData: FormData) {
  ...
  try {
    ...
    redirectActionError(recipeId ? `/recipes/${recipeId}/edit` : "/recipes", error, "recipes.update_failed", userId);
  }
}
...
export async function saveNote(formData: FormData) {
  ...
  try {
    ...
    redirectActionError(recipeId ? `/recipes/${recipeId}` : "/recipes", error, "recipes.note_failed", userId);
  }
}
...
export async function copyToMyBook(formData: FormData) {
  ...
  try {
    ...
    redirectActionError(recipeId ? `/recipes/${recipeId}` : "/recipes", error, "recipes.copy_failed", userId);
  }
}
...
export async function recordMemory(formData: FormData) {
  ...
  try {
    ...
    const path =
      returnTo === "cook" && recipeId ? `/recipes/${recipeId}/cook` : recipeId ? `/recipes/${recipeId}` : "/recipes";
    redirectActionError(path, error, "recipes.memory_failed", userId);
  }
}
...
export async function removeMemory(formData: FormData) {
  ...
  try {
    ...
    redirectActionError(recipeId ? `/recipes/${recipeId}` : "/recipes", error, "recipes.memory_remove_failed", userId);
  }
}
...
export async function applyTranscript(formData: FormData) {
  ...
  try {
    ...
    redirectActionError(recipeId ? `/recipes/${recipeId}` : "/recipes", error, "recipes.transcript_apply_failed", userId);
  }
}
...
export async function toggleFavorite(formData: FormData) {
  ...
  try {
    ...
    reportError("recipes.favorite_failed", error, userId ? { userId } : undefined);
    throw error;
  }
}
